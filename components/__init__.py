...
from .tile_map_statistic_components import (
    TileMapTilesComponent as TileMapTilesComponent,
    TileMapChunksComponent as TileMapChunksComponent,
    TileMapSpritesComponent as TileMapSpritesComponent
)
